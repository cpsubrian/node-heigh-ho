...
Queue.prototype.run = function () {
  // @todo First, process any events that are 'stuck' in the pending queue.
  //       Then, set up subscriptions for processing new jobs.
  //       Question: Should we have a timeout where we check the pending queue
  //       in case the pub/sub is unreliable? Probably no, we need to trust
  //       the pub/sub.
};
